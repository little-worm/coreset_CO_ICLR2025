...
import numpy as np
from catNips2024Code_0313._my_CO2024.myCoreset_mis.mytreePackage.myTree_mis import my_RWD_coreset
...
def my_generate_RWDdata(org_filepath,org_filename,kk,maxPoolNum,ballRadius_RWD=0.052,my_embeding_dim=3):
    ...
    coreset_misFilename_list = my_RWD_coreset(global_misFilename_list,ballRadius_RWD,kk,maxPoolNum,my_embeding_dim=my_embeding_dim)
