...
def my_generate_uniform_sampling(global_misFilename_list,uniform_sampling_size,seed,):
    ...
    save_path = "my_dataCO/DIFCUSO_data/mis_sat/training_sat"
    os.makedirs(save_path,exist_ok=True)
    for cf in my_samples_misFilename_list:
        shutil.move(cf,save_path)
    ...
    for cf in coreset_misFilename_result_list:
        shutil.move(cf,save_path+"/train_annotations")
    ...
    for cf in coreset_misFilename_result_list:
        shutil.move(cf,save_path+"/preprocessed/kamis")
        
    print("")

seed = 1234; size_list = [500]



global_misFilename_list =  glob.glob("my_dataCO/DIFCUSO_data/mis_sat/mis_sat_training_test40000/*.gpickle")
