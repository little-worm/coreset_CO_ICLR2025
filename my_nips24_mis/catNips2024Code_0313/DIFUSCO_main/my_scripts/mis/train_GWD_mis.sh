...
my_training_split="mis_er/RWD_coreset/res_mis_er128000_r"$r"_kk4_pool"$pool_num"_"$my_sample_size"/*gpickle" 
my_training_split_label_dir="mis_er/RWD_coreset/res_mis_er128000_r"$r"_kk4_pool"$pool_num"_"$my_sample_size"/train_annotations/"
...
python -u catNips2024Code_0313/DIFUSCO_main/difusco/train.py \
  --task "mis" \
  --wandb_logger_name "train-mis_er-GWD"$my_sample_size \
  ...
  --my_result_path "my_result/mis_er-GWD"$my_sample_size \
  --project_name "mis" \
