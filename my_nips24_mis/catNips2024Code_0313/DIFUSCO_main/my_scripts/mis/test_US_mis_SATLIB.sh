...
my_sample_size=6250; my_ckpt_path="my_result/mis_er-US206250/models/train-mis_er-US6250/dz6mazb0/checkpoints/last.ckpt"
my_sample_size=12417; my_ckpt_path="my_result/mis_er-US2012417/models/train-mis_er-US12417/c7knf6pk/checkpoints/last.ckpt"
# my_sample_size=19086; my_ckpt_path="my_result/mis_er-US2019086/models/train-mis_er-US19086/8o478214/checkpoints/last.ckpt"
my_test_split_list=(
...
for my_parallel_sampling in 1 4; do
  for my_test_split in "${my_test_split_list[@]}"; do
    ...
    python -u catNips2024Code_0313/DIFUSCO_main/difusco/train.py \
      --task "mis" \
      --wandb_logger_name "test-SATLIB-US"$my_sample_size"_"$my_parallel_sampling \
      ...
      --my_result_path "my_result/SATLIB-US"$my_num_epochs$my_sample_size \
      --project_name "mis" \
      --resume_weight_only
  done
done
