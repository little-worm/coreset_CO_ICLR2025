...
#<<< 
# #----------
my_ckpt_path="my_result/trainUniform_tsp100_3ddim/models/trainUniform_tsp100_US4321/bmrj37lq/checkpoints/last.ckpt"
my_Guass_std=0;  tmp_data_path_r='1.004';  tmp_data_path_kk='4'; my_coreset_size='4321'; dim_mode="ddim"; plus_size=3000
# #----------
# my_ckpt_path="my_result/trainUniform_tsp100_3ddim/models/trainUniform_tsp100_US7817/3wfp3qtf/checkpoints/last.ckpt"
# my_Guass_std=1;  tmp_data_path_r='0.945';  tmp_data_path_kk='4'; my_coreset_size='7817'; dim_mode="ddim"; plus_size=3000
# # # #----------
# my_ckpt_path="my_result/trainUniform_tsp100_3ddim/models/trainUniform_tsp100_US13181/syakw25s/checkpoints/last.ckpt"
...
for my_test_node_num in 200; do
    ...
    my_test_data_list=(
                    ...
                    "../tsp"$my_test_node_num"_"$point_dim$dim_mode"_plus3000/tsp"$my_test_node_num"_test_Uniform_seed666_"$my_test_sample_num"_3ddim.txt"
                    )
