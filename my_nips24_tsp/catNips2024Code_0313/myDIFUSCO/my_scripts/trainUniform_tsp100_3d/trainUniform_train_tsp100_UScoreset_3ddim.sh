...
#<<<  
my_Guass_std=1;  tmp_data_path_r='1.004';  tmp_data_path_kk='4'; my_coreset_size='4233'; dim_mode="ddim"; plus_size=3000
...
my_test_data="tsp100_test_Uniform_seed666_1280_3ddim.txt"
...
python -u catNips2024Code_0313/myDIFUSCO/difusco/train.py \
  --task "tsp" \
  --wandb_logger_name "trainUniform_tsp100_US"$my_coreset_size \
