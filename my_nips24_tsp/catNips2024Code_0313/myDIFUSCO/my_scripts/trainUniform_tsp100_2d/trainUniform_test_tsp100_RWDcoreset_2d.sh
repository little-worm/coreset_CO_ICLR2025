...
for my_test_node_num in 100 200 500 1000; do
    ...
    my_test_data_list=(
                    # "../../../tsp"$my_test_node_num"_"$point_dim$dim_mode"_plus3000/tsp"$my_test_node_num"_test_Guass_0_1_seed666_"$my_test_sample_num"_2d.txt"
                    # "../../../tsp"$my_test_node_num"_"$point_dim$dim_mode"_plus3000/tsp"$my_test_node_num"_test_Guass_0_2_seed666_"$my_test_sample_num"_2d.txt"
                    # "../../../tsp"$my_test_node_num"_"$point_dim$dim_mode"_plus3000/tsp"$my_test_node_num"_test_Guass_0_4_seed666_"$my_test_sample_num"_2d.txt"
                    # "../../../tsp"$my_test_node_num"_"$point_dim$dim_mode"_plus3000/tsp"$my_test_node_num"_test_Guass_0_8_seed666_"$my_test_sample_num"_2d.txt"
                    "../../../tsp"$my_test_node_num"_"$point_dim$dim_mode"_plus3000/tsp"$my_test_node_num"_test_Uniform_seed666_"$my_test_sample_num"_2d.txt"
                    )
  for my_two_opt_iterations in 0 1000; do
    for my_test_data in "${my_test_data_list[@]}"; do
      ...
      python -u catNips2024Code_0313/myDIFUSCO/difusco/train.py \
        --task "tsp" \
        --wandb_logger_name "trainUniform_test"$my_test_node_num"-tsp100_RWD"$my_coreset_size \
