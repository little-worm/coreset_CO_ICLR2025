...
# my_test_data="tsp"$my_test_node_num"_2d_plus3000/tsp"$my_test_node_num"_test_Guass_0_1_seed666_"$my_test_sample_num"_2d_aligned.txt"
# my_test_data="tsp"$my_test_node_num"_2d_plus3000/tsp"$my_test_node_num"_test_Guass_0_2_seed666_"$my_test_sample_num"_2d_aligned.txt"
# my_test_data="tsp"$my_test_node_num"_2d_plus3000/tsp"$my_test_node_num"_test_Guass_0_4_seed666_"$my_test_sample_num"_2d_aligned.txt"
# my_test_data="tsp"$my_test_node_num"_2d_plus3000/tsp"$my_test_node_num"_test_Guass_0_8_seed666_"$my_test_sample_num"_2d_aligned.txt"
# my_test_data="tsp"$my_test_node_num"_2d_plus3000/tsp"$my_test_node_num"_test_Uniform_seed666_"$my_test_sample_num"_2d_aligned.txt"
...
for my_test_node_num in 100 200 500 1000; do
    ...
    my_test_data_list=(
                    # "tsp"$my_test_node_num"_test_Guass_0_1_seed666_"$my_test_sample_num"_2d_aligned.txt"
                    # "tsp"$my_test_node_num"_test_Guass_0_2_seed666_"$my_test_sample_num"_2d_aligned.txt"
                    # "tsp"$my_test_node_num"_test_Guass_0_4_seed666_"$my_test_sample_num"_2d_aligned.txt"
                    # "tsp"$my_test_node_num"_test_Guass_0_8_seed666_"$my_test_sample_num"_2d_aligned.txt"
                    "tsp"$my_test_node_num"_test_Uniform_seed666_"$my_test_sample_num"_2d_aligned.txt"
                    )
