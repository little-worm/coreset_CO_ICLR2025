...
export CUDA_VISIBLE_DEVICES=0; my_two_opt_iterations=1000; my_test_node_num=100
...
#<<< RWD 226776
my_ckpt_path="my_result/tsp_org/models/train-tsp100_Guass_org/uqn2e0rv/checkpoints/last.ckpt"
#>>>

my_test_data_array=("tsp"$my_test_node_num"_2d_plus3000/tsp"$my_test_node_num"_test_Guass_0_1_seed666_"$my_test_sample_num"_2d.txt"
...
for my_test_data in "${my_test_data_array[@]}"; do
