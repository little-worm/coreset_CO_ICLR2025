...
# my_Guass_std=1;  tmp_data_path_r='0.058'; tmp_data_path_kk='4'; my_coreset_size='5941';  dim_mode="d"; plus_size=3000
# my_Guass_std=1;  tmp_data_path_r='0.054';  tmp_data_path_kk='4'; my_coreset_size='8245'; dim_mode="d"; plus_size=3000
# my_Guass_std=1;  tmp_data_path_r='0.052';  tmp_data_path_kk='4'; my_coreset_size='10367'; dim_mode="d"; plus_size=3000
# my_Guass_std=1;  tmp_data_path_r='0.05';  tmp_data_path_kk='4'; my_coreset_size='12951'; dim_mode="d"; plus_size=3000
my_Guass_std=1;  tmp_data_path_r='0.048';  tmp_data_path_kk='4'; my_coreset_size='16938'; dim_mode="d"; plus_size=3000
...
tmp_batch_size=64
tmp_num_epochs=20
#my_test_data="tsp100_test_Guass_0_"$my_Guass_std"_seed666_1280_"$point_dim$dim_mode".txt"
...
python -u catNips2024Code_0313/myDIFUSCO/difusco/train.py \
  --task "tsp" \
  --wandb_logger_name "train-tsp100_US"$my_coreset_size \
  ...
  --training_split "trainN01_myUniformSample_data/tsp100_train_Guass_0_"$my_Guass_std"_seed1234_128000_"$point_dim$dim_mode"plus_"$plus_size"_"$my_coreset_size"_seed1234.txt" \
