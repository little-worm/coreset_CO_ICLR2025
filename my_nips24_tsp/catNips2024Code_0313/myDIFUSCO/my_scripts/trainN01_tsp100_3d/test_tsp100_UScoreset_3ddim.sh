...
#<<< 
my_ckpt_path="my_result/tsp100_3ddim/models/train-tsp100_US4103/uwq056iv/checkpoints/last.ckpt"
my_Guass_std=1;  tmp_data_path_r='0.085'; tmp_data_path_kk='4'; my_coreset_size='4103';  dim_mode="ddim"; plus_size=3000
#----------
my_ckpt_path="my_result/tsp100_3ddim/models/train-tsp100_US7960/l5czlea6/checkpoints/last.ckpt"
my_Guass_std=1;  tmp_data_path_r='0.07'; tmp_data_path_kk='4'; my_coreset_size='7960';  dim_mode="ddim"; plus_size=3000
#----------
my_ckpt_path="my_result/tsp100_3ddim/models/train-tsp100_US12058/w1w0sjvl/checkpoints/last.ckpt"
...
python -u catNips2024Code_0313/myDIFUSCO/difusco/train.py \
  --task "tsp" \
  --wandb_logger_name "test"$my_test_node_num"-tsp100_US"$my_coreset_size \
