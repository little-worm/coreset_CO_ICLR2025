...
from my_para_cvrp_rand_test import *
##########################################################################################
# parameters
...
########### model ###############
model_load_path = my_save_model_path
...
test_paras = {
   # problem_size: [filename, episode, batch]
    100: [ 'vrp100_test_lkh.txt',1280,1280],
...
env_params = {
    ...
    # 'data_path':"/cat_nips24_cvrp/my_dataCO/LEHD_data/vrp200_test_lkh.txt",
    'sub_path': False,
...
tester_params = {
    "save_model_path":my_save_model_path,
    'use_cuda': USE_CUDA,
