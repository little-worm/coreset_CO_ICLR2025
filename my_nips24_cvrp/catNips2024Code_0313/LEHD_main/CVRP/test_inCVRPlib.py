...
from LEHD_main.CVRP.Tester_inCVRPlib import VRPTester as Tester
...
from my_para_cvprlib import *
########### model ###############

model_load_epoch = my_epochs
...
test_paras = {
   # problem_size: [filename, episode, batch]
    ...
    666: ['my_vrplib_109instances.txt', 192, 1, 0 ]
...
env_params = {
    ...
    'vrplib_path': "/cat_nips24_cvrp/my_dataCO/LEHD_data/" + test_paras[problem_size][0],
    'data_path':"/cat_nips24_cvrp/my_dataCO/LEHD_data/" + test_paras[problem_size][0],
    'sub_path': False,
...
logger_params = {
    'log_file': {
        'desc': f'test__vrp{problem_size}_{method}{sample_size}_{RRC_budget}',
        'filename': 'log.txt'
    }
}
