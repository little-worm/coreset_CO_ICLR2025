...
# import subprocess
# import os
# def my_gen_sloution_file(instance_num,working_dir):
#     
#     sol_file = os.path.abspath(working_dir + str(instance_num) + ".sol")
#     # problem = lkh.LKHProblem.parse(problem_str)
#     # 
#     # lkh.solve(lkh_executable, problem=problem, max_trials=10000, runs=10)


#     # Path to the LKH executable
#     solver_path = "catNips2024Code_0313/LKH-3.0.6/LKH"

#     # Read the parameter (.par) and problem (.vrp) files
#     with open(par_file, 'r') as par_file:
#         problem_str = par_file.read()

#     # Parse the problem using the wrapper's parser
#     problem = lkh.LKHProblem.parse(problem_str)
...
#     # Save the solution to a .sol file
