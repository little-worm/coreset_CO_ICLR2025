...
from catNips2024Code_0313.LEHD_main.CVRP.VRPTrainer import VRPTrainer as Trainer
from catNips2024Code_0313.LEHD_main.CVRP.my_para_cvrp_rand_test import *
##########################################################################################
# parameters
b = os.path.abspath(".").replace('\\', '/')
from my_para_cvrp_rand_train import *

# training_data_path = b + '/data/vrp100_hgs_train_100w.txt'
# training_data_path = "/cat_nips24_cvrp/vrp100_hgs_train_100w-001.txt"
# training_data_path = "/cat_nips24_cvrp/tmp.txt"
...
trainer_params = {
    ...
    'epochs': my_epochs,
    'train_episodes': my_train_episodes,
