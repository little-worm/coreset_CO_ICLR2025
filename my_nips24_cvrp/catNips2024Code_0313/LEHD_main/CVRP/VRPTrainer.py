...
from catNips2024Code_0313.LEHD_main.CVRP.VRPModel import VRPModel as Model
from catNips2024Code_0313.LEHD_main.CVRP.test import main_test
from catNips2024Code_0313.LEHD_main.CVRP.VRPEnv import VRPEnv as Env
...
class VRPTrainer:
    def __init__(self,
        ...
        if model_load['enable']:
            checkpoint_fullname = self.trainer_params["save_model_path"]
    ...
    def run(self):
        ...
        for epoch in range(self.start_epoch, self.trainer_params['epochs']+1):
            ...
            if all_done or (epoch % model_save_interval) == 0:
                ...
                torch.save(checkpoint_dict, self.trainer_params["save_model_path"])
