...
def my_RWD_coreset(global_locations_list,global_weights_list,ballRadius_RWD=20,kk=4,maxPoolNum=40,ballRadius_pointset=1,point_num_threshold=100,maxIterTimes_RWD=1):
...
def test_my_RWD_coreset():
    ...
    global_weights_list = np.random.rand(10000,100) 
    ...
    my_RWD_coreset(global_locations_list,global_weights_list,ballRadius_RWD=0.01,kk=4,maxPoolNum=40,ballRadius_pointset=1,point_num_threshold=100,maxIterTimes_RWD=1)
